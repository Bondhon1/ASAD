...
export const bangladeshGeo: BangladeshDivision[] = [
  {
    name: "Dhaka",
    districts: [
      { name: "Dhaka", upazilas: ["Dhamrai", "Dohar", "Keraniganj", "Nawabganj", "Savar"], cityCorporations: ["Dhaka North", "Dhaka South"] },
      { name: "Faridpur", upazilas: ["Faridpur Sadar", "Alfadanga", "Bhanga", "Boalmari", "Nagarkanda"] },
      { name: "Gazipur", upazilas: ["Gazipur Sadar", "Kaliakair", "Kapasia", "Kaliganj", "Sreepur"], cityCorporations: ["Gazipur"] },
      ...
      { name: "Narayanganj", upazilas: ["Narayanganj Sadar", "Araihazar", "Bandar", "Rupganj", "Sonargaon"], cityCorporations: ["Narayanganj"] },
  ...
  },
  {
    name: "Chattogram",
    districts: [
      { name: "Chattogram", upazilas: ["Chattogram Sadar", "Anwara", "Boalkhali", "Hathazari", "Mirsharai", "Patiya", "Raozan", "Sitakunda"], cityCorporations: ["Chattogram"] },
      { name: "Cox's Bazar", upazilas: ["Cox's Bazar Sadar", "Chakaria", "Kutubdia", "Maheshkhali", "Ramu", "Teknaf", "Ukhia"] },
      { name: "Cumilla", upazilas: ["Cumilla Adarsha Sadar", "Cumilla Sadar Dakshin", "Barura", "Brahmanpara", "Chandina", "Debidwar", "Daudkandi", "Homna", "Laksam", "Muradnagar"], cityCorporations: ["Cumilla"] },
  ...
  },
  {
    name: "Rajshahi",
    districts: [
      { name: "Rajshahi", upazilas: ["Rajshahi Sadar", "Bagha", "Bagmara", "Charghat", "Durgapur", "Godagari", "Mohanpur", "Paba", "Puthia", "Tanore"], cityCorporations: ["Rajshahi"] },
  ...
  },
  {
    name: "Khulna",
    districts: [
      { name: "Khulna", upazilas: ["Khulna Sadar", "Batiaghata", "Dacope", "Dumuria", "Koyra", "Paikgachha", "Phultala", "Rupsa", "Terokhada"], cityCorporations: ["Khulna"] },
  ...
  },
  {
    name: "Barishal",
    districts: [
      { name: "Barishal", upazilas: ["Barishal Sadar", "Agailjhara", "Babuganj", "Bakerganj", "Banaripara", "Gournadi", "Hizla", "Mehendiganj", "Muladi", "Uzirpur"], cityCorporations: ["Barishal"] },
  ...
  },
  {
    name: "Sylhet",
    districts: [
      { name: "Sylhet", upazilas: ["Sylhet Sadar", "Balaganj", "Bishwanath", "Companiganj", "Dakshin Surma", "Fenchuganj", "Golapganj", "Gowainghat", "Jaintiapur", "Zakiganj"], cityCorporations: ["Sylhet"] },
  ...
  },
  {
    name: "Rangpur",
    districts: [
      { name: "Rangpur", upazilas: ["Rangpur Sadar", "Badarganj", "Gangachara", "Kaunia", "Mithapukur", "Pirgachha", "Pirganj", "Taraganj"], cityCorporations: ["Rangpur"] },
  ...
  },
  {
    name: "Mymensingh",
    districts: [
      { name: "Mymensingh", upazilas: ["Mymensingh Sadar", "Bhaluka", "Dhobaura", "Fulbaria", "Gaffargaon", "Gouripur", "Haluaghat", "Ishwarganj", "Muktagachha", "Nandail", "Phulpur", "Trishal"], cityCorporations: ["Mymensingh"] },
...
export const getCityCorporations = (division?: string, district?: string) => {
  const div = bangladeshGeo.find((d) => d.name === division);
  const dist = div?.districts.find((d) => d.name === district);
  return dist?.cityCorporations ?? [];
};
