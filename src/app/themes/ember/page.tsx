/* Theme: Ember - Orange & White - Energetic & Warm */
"use client";
...
export default function EmberTheme() {
  ...
  return (
    <div className="min-h-screen bg-white" style={{ fontFamily: 'var(--font-nunito), system-ui, sans-serif' }}>
        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="flex h-20 items-center justify-between">
            <Link href="#" className="flex items-center gap-3 group">
              <div className="relative h-10 w-10 overflow-hidden rounded-xl ring-2 ring-[#f97316] transition-transform duration-300 group-hover:scale-110">
            ...
            <div className="hidden md:flex items-center gap-8">
              {['Home', 'About', 'Sectors', 'Activities', 'Contact'].map((item) => (
                <Link key={item} href="#" className="text-sm font-semibold text-gray-600 hover:text-[#f97316] transition-colors duration-300">{item}</Link>
              ))}
              <Link href="#join" className="rounded-lg bg-gradient-to-r from-[#f97316] to-[#ea580c] px-6 py-2.5 text-sm font-bold text-white hover:shadow-lg hover:shadow-orange-500/30 transition-all duration-300 hover:scale-105">Join Us</Link>
            </div>
          ...
          <div className="flex flex-col gap-4 px-6">
            {['Home', 'About', 'Sectors', 'Activities', 'Contact'].map((item, i) => (
              <Link 
                ...
                className="text-base font-semibold text-gray-600 hover:text-[#f97316] transition-all duration-300"
                style={{ animationDelay: `${i * 0.1}s` }}
              >
                {item}
              </Link>
            ))}
            <Link href="#join" onClick={() => setMobileMenuOpen(false)} className="rounded-lg bg-gradient-to-r from-[#f97316] to-[#ea580c] px-6 py-3 text-center text-sm font-bold text-white transition-all duration-300">Join Us</Link>
          </div>
        </div>
      </nav>
      ...
      <section ref={heroAnim.ref} className="relative min-h-[85vh] flex items-center pt-20 overflow-hidden">
        <div className="absolute inset-0">
          <Image
            ...
            priority
          />
          <div className="absolute inset-0 bg-gradient-to-r from-[#f97316]/95 via-[#ea580c]/90 to-[#c2410c]/85" />
        </div>
        {/* Decorative circles */}
        ...
        <div className="relative z-10 mx-auto w-full max-w-7xl px-6 py-20">
          <div className="max-w-3xl">
            <span className={`inline-block rounded-full bg-white/20 px-4 py-2 text-sm font-semibold uppercase tracking-widest text-white backdrop-blur-sm transition-all duration-700 ${heroAnim.isInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            ...
            <div className={`mt-10 flex flex-wrap gap-4 transition-all duration-700 delay-300 ${heroAnim.isInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
              <Link
                ...
                className="rounded-lg bg-white px-8 py-4 text-lg font-bold text-[#f97316] shadow-xl transition-all duration-300 hover:bg-gray-100 hover:shadow-2xl hover:scale-105"
              >
                {heroContent.primaryAction.label}
              </Link>
              <Link
                href={heroContent.secondaryAction.href}
                className="rounded-lg border-2 border-white px-8 py-4 text-lg font-bold text-white transition-all duration-300 hover:bg-white/10"
              >
      ...
      {/* About Section */}
      <section ref={aboutAnim.ref} className="bg-gradient-to-b from-orange-50 to-white px-6 py-32">
        <div className="mx-auto max-w-7xl">
          <div className="grid gap-16 lg:grid-cols-2">
            <div className={`transition-all duration-700 ${aboutAnim.isInView ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-12'}`}>
              <span className="text-sm font-bold uppercase tracking-widest text-[#f97316]">{aboutContent.eyebrow}</span>
              ...
              <Link href={aboutContent.learnMore.href} className="mt-8 inline-flex items-center gap-2 text-lg font-bold text-[#f97316] hover:text-[#ea580c] transition-colors duration-300">
            ...
            <div className={`grid gap-6 transition-all duration-700 delay-200 ${aboutAnim.isInView ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-12'}`}>
              <div className="rounded-3xl bg-gradient-to-br from-[#f97316] to-[#ea580c] p-8 text-white shadow-xl transform hover:scale-[1.02] transition-transform duration-300">
              ...
              <div className="rounded-3xl bg-white p-8 shadow-xl ring-1 ring-orange-100 transform hover:scale-[1.02] transition-transform duration-300">
                <h3 className="text-sm font-bold uppercase tracking-widest text-[#f97316]">Our Vision</h3>
      ...
      <section ref={sectorsAnim.ref} className="bg-white px-6 py-24">
        <div className="mx-auto max-w-7xl">
          <div className={`text-center transition-all duration-700 ${sectorsAnim.isInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            <span className="text-sm font-bold uppercase tracking-widest text-[#f97316]">Our Sectors</span>
          ...
          <div className="mt-16 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {sectors.map((sector, i) => (
              <div 
                key={i} 
                className={`group rounded-2xl bg-orange-50 p-6 transition-all duration-500 hover:bg-gradient-to-br hover:from-[#f97316] hover:to-[#ea580c] hover:shadow-xl hover:scale-105 ${sectorsAnim.isInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}`}
                style={{ transitionDelay: `${i * 100}ms` }}
              >
                <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-[#f97316] text-xl font-bold text-white group-hover:bg-white group-hover:text-[#f97316] transition-all duration-300">
                  {sector.name.charAt(0)}
                </div>
                <h3 className="mt-4 text-xl font-bold text-gray-900 group-hover:text-white transition-colors duration-300">{sector.name}</h3>
                <p className="mt-2 text-gray-600 group-hover:text-white/90 transition-colors duration-300">{sector.summary}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* Volunteer Journey */}
      <section ref={journeyAnim.ref} className="bg-gradient-to-br from-[#f97316] via-[#ea580c] to-[#c2410c] px-6 py-24">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-16 grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            {journeySteps.map((step, i) => (
              <div 
                ...
                style={{ transitionDelay: `${i * 150}ms` }}
              >
                <div className="flex h-10 w-10 items-center justify-center rounded-full bg-white text-lg font-bold text-[#f97316]">
                  {i + 1}
                </div>
      ...
      <section ref={activitiesAnim.ref} className="bg-white px-6 py-24">
        <div className="mx-auto max-w-7xl">
          <div className={`text-center transition-all duration-700 ${activitiesAnim.isInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            <span className="text-sm font-bold uppercase tracking-widest text-[#f97316]">Activities</span>
          ...
          <div className="mt-16 grid gap-8 lg:grid-cols-3">
            {activities.map((activity, i) => (
              <div 
                key={i} 
                className={`rounded-2xl border-2 border-orange-100 p-8 transition-all duration-500 hover:border-[#f97316] hover:shadow-xl ${activitiesAnim.isInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}`}
                style={{ transitionDelay: `${i * 150}ms` }}
              >
                ...
                <ul className="mt-4 space-y-3">
                  {activity.points.map((point, j) => (
                    <li key={j} className="flex items-start gap-3 text-gray-600">
                      <span className="mt-1.5 h-2 w-2 flex-shrink-0 rounded-full bg-[#f97316]" />
                      {point}
                    </li>
                  ))}
                </ul>
        ...
        <div className="relative z-10 mx-auto max-w-7xl">
          <div className="grid gap-12 lg:grid-cols-2 items-center">
            <div className={`transition-all duration-700 ${projectAnim.isInView ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-12'}`}>
              <span className="text-sm font-bold uppercase tracking-widest text-[#f97316]">Featured Project</span>
              ...
              <Link
                ...
                className="mt-8 inline-flex rounded-lg bg-gradient-to-r from-[#f97316] to-[#ea580c] px-8 py-4 text-lg font-bold text-white shadow-xl transition-all duration-300 hover:shadow-orange-500/30 hover:scale-105"
              >
            ...
            <div className={`grid grid-cols-2 gap-4 transition-all duration-700 delay-200 ${projectAnim.isInView ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-12'}`}>
              {[
                ...
                <div key={i} className="rounded-2xl bg-white/10 p-6 backdrop-blur-sm border border-white/20 hover:bg-white/20 transition-all duration-300">
                  ...
                  <p className="mt-2 text-sm font-medium uppercase tracking-wider text-[#f97316]">{item.label}</p>
                </div>
              ))}
            </div>
          </div>
      ...
      {/* Notices */}
      <section ref={noticesAnim.ref} className="bg-orange-50 px-6 py-24">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-10 grid gap-6 md:grid-cols-3">
            {notices.map((notice, i) => (
              <div 
                ...
                style={{ transitionDelay: `${i * 100}ms` }}
              >
                <div className="h-1 w-12 rounded-full bg-gradient-to-r from-[#f97316] to-[#ea580c]" />
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-16 grid gap-6 md:grid-cols-2">
            {joinOptions.map((option, i) => (
              <div 
                key={i} 
                className={`rounded-2xl bg-orange-50 p-8 transition-all duration-500 hover:shadow-xl hover:bg-gradient-to-br hover:from-[#f97316] hover:to-[#ea580c] group ${joinAnim.isInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}`}
                style={{ transitionDelay: `${i * 100}ms` }}
              >
                <h3 className="text-xl font-bold text-gray-900 group-hover:text-white transition-colors duration-300">{option.title}</h3>
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-8 flex flex-wrap items-center justify-center gap-8">
            {partners.map((partner, i) => (
              <div key={i} className="rounded-xl bg-white px-6 py-3 text-sm font-semibold text-gray-600 shadow hover:shadow-lg hover:text-[#f97316] transition-all duration-300 hover:scale-105">
                {partner}
              </div>
            ))}
          </div>
      ...
      <footer className="bg-gray-900 px-6 py-16 text-white">
        <div className="mx-auto max-w-7xl">
          <div className="grid gap-12 md:grid-cols-3">
            ...
            <div>
              <h4 className="font-bold uppercase tracking-wider text-[#f97316]">Quick Links</h4>
              <div className="mt-4 flex flex-col gap-2 text-gray-400">
                <Link href="#" className="hover:text-[#f97316] transition-colors duration-300">Home</Link>
                <Link href="#" className="hover:text-[#f97316] transition-colors duration-300">About Us</Link>
                <Link href="#" className="hover:text-[#f97316] transition-colors duration-300">Activities</Link>
                <Link href="#" className="hover:text-[#f97316] transition-colors duration-300">Contact</Link>
              </div>
            </div>
            <div>
              <h4 className="font-bold uppercase tracking-wider text-[#f97316]">Contact</h4>
