  ...
  return (
    <div className="min-h-screen bg-white" style={{ fontFamily: 'var(--font-poppins), system-ui, sans-serif' }}>
        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="flex h-20 items-center justify-between">
            <Link href="#" className="flex items-center gap-3">
              <div className="relative h-11 w-11 overflow-hidden rounded-2xl shadow-lg shadow-orange-500/30">
            ...
            <div className="hidden md:flex items-center gap-8">
              {['Home', 'About', 'Sectors', 'Activities', 'Contact'].map((item) => (
                <Link key={item} href="#" className="text-sm font-bold text-gray-600 hover:text-[#F7941D] transition">{item}</Link>
              ))}
      ...
      <section className="relative min-h-[95vh] flex items-center overflow-hidden pt-20">
        ...
        {/* Decorative circles */}
        <div className="absolute -top-32 -right-32 w-96 h-96 rounded-full bg-yellow-300/20 blur-3xl" />
        ...
        <div className="relative z-10 mx-auto w-full max-w-7xl px-6 py-20">
          <div className="grid lg:grid-cols-[1.3fr_0.7fr] gap-16 items-center">
            <div>
              <div className="inline-flex items-center gap-3 rounded-full bg-white/20 px-5 py-2.5 backdrop-blur-sm">
              ...
              <div className="mt-10 flex flex-wrap gap-4">
                <Link
                  ...
                  className="group rounded-full bg-white px-10 py-5 text-lg font-bold text-[#F7941D] shadow-2xl transition-all hover:scale-105 hover:shadow-white/30"
                >
                ...
                <Link
                  ...
                  className="rounded-full border-2 border-white px-10 py-5 text-lg font-bold text-white transition hover:bg-white/10"
                >
        ...
        <div className="mx-auto max-w-7xl">
          <div className="grid gap-16 lg:grid-cols-2 items-center">
            ...
            <div className="order-1 lg:order-2 space-y-6">
              <div className="rounded-[32px] bg-gradient-to-br from-[#F7941D] to-[#FF6B35] p-10 text-white shadow-2xl shadow-orange-500/30">
              ...
              <div className="rounded-[32px] bg-gray-50 p-10 shadow-lg">
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-16 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {sectors.map((sector, i) => (
              <div key={i} className="group rounded-[28px] bg-white p-8 shadow-lg transition-all hover:-translate-y-2 hover:shadow-2xl hover:shadow-orange-500/10">
      ...
      {/* Activities */}
      <section className="bg-gradient-to-br from-[#F7941D] to-[#C73E1D] px-6 py-24">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid gap-6 lg:grid-cols-3">
            {activities.map((activity, i) => (
              <div key={i} className="rounded-[28px] bg-white/10 backdrop-blur-sm p-8 border border-white/20">
      ...
      {/* Project Alokdhara */}
      <section className="relative min-h-[75vh] flex items-center px-6 py-24">
        <div className="absolute inset-0">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <Link
                ...
                className="mt-10 inline-flex rounded-full bg-gradient-to-r from-[#F7941D] to-[#FF6B35] px-10 py-5 text-lg font-bold text-white shadow-2xl shadow-orange-500/30 transition hover:scale-105"
              >
            ...
            <div className="hidden lg:grid grid-cols-2 gap-4">
              {[
                ...
                <div key={i} className="rounded-[24px] bg-white/10 backdrop-blur-md p-6 text-center border border-white/10">
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-3">
            {notices.map((notice, i) => (
              <div key={i} className="group rounded-[28px] bg-gray-50 p-8 transition-all hover:bg-gradient-to-br hover:from-[#F7941D] hover:to-[#FF6B35] hover:shadow-2xl hover:shadow-orange-500/20">
                <span className="inline-flex h-10 w-10 items-center justify-center rounded-full bg-[#F7941D]/10 text-sm font-bold text-[#F7941D] group-hover:bg-white/20 group-hover:text-white">
                  {i + 1}
                </span>
                <h3 className="mt-5 text-lg font-bold text-gray-900 group-hover:text-white">{notice.title}</h3>
                <p className="mt-3 text-gray-600 group-hover:text-white/80">{notice.detail}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-10 flex flex-wrap items-center justify-center gap-6">
            {partners.map((partner, i) => (
              <div key={i} className="rounded-full bg-gray-50 px-8 py-4 text-sm font-bold text-gray-600 shadow-md hover:shadow-lg transition-shadow">
                {partner}
              </div>
            ))}
          </div>
